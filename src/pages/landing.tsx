  ...
  <div className="flex-1 bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
    <div className="w-16 h-16 bg-blue-50 rounded-2xl flex items-center justify-center mb-6">
      <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <p className="text-base text-gray-600 leading-relaxed">Procesare accelerată a cererilor în 24-48 ore lucrătoare.</p>
  </div>
  ...
  <div className="flex-1 bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
    <div className="w-16 h-16 bg-blue-50 rounded-2xl flex items-center justify-center mb-6">
      <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <p className="text-base text-gray-600 leading-relaxed">Datele dvs. sunt protejate conform standardelor europene.</p>
  </div>
  <div className="flex-1 bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
    <div className="w-16 h-16 bg-blue-50 rounded-2xl flex items-center justify-center mb-6">
      <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <p className="text-base text-gray-600 leading-relaxed">Notificări instant la fiecare etapă a procesului vamal.</p>
  </div>
</div>
<div className="max-w-6xl mx-auto px-4 py-12">
  <h1 className="text-3xl md:text-4xl font-bold text-gray-900 text-center mb-12"> Pentru toate tipurile de utilizatori</h1>
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
      <div className="flex items-start gap-4">
        <div className="flex-shrink-0 w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
          ...
          <p className="text-gray-600 leading-relaxed">Interfață simplificată pentru gestionarea coletelor personale. Înregistrare rapidă și urmărire intuitivă a statusului.</p>
        </div>
      </div>
    </div>
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-600 leading-relaxed">Funcționalități avansate pentru companii: comenzi recurente, istoric plăți, rapoarte și gestionare în bloc.</p>
        </div>
      </div>
    </div>
  </div>
