...
export default function BusinessPackages() {
    ...
    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-2xl font-bold" style={{ color: '#1B3A5F' }}>Colete companie</h1>
                <p className="mt-1 text-sm text-gray-500">Coletele scanate și datele preluate pentru companie.</p>
            </div>
            ...
            <PackagesTable packages={packages} emptyMessage="Nu există colete asociate companiei." recipientType="business" />
        </div>
    )
}
